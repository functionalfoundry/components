// Based on https://github.com/Soreine/draft-js-simpledecorator/blob/master/index.js
 ...
 */
function SimpleDecorator(strategy, getComponent, originalProps) {
    this.decorated = {};
...
SimpleDecorator.prototype.getDecorations = function(block) {
    ...
    const callback = (start, end, props) => {
        if (props === undefined) {
            props = {};
        }
        key = blockKey + KEY_SEPARATOR + decorationId;
        decorated[blockKey][decorationId] = { ...this.originalProps, ...props };
